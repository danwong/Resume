...
\name{Daniel P.}{Wong}
%---\address{Castro Valley, CA \& San Luis Obispo, CA}
\mobile{(510) 432-1118}

\email{ dwong56@calpoly.edu}
\homepage{www.danielpwong.com}
\github{danwong}
\linkedin{dapwong}
%\skype{skypeid}
...
\makecvfooter{\today}{Daniel P. Wong~~~·~~~Résumé~~~.~~~Written with LaTeX and Vim}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
